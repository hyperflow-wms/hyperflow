 ...
 **
 ** Implementation of Finite State Machine of a continuous 'choice' task. This task waits for all
 ** data inputs, invokes the task's function, and emits SOME (or none) data outputs.
 **
 ** Inputs:
    ...
    this.running_onEnter = function(session, state, transition, msg) {
        ...
        async.waterfall([
                ...
                function(outs, cb) {
                    ...
                    var outValues = [];
                    //console.log("CHOICE OUTS: ", outs, funcOuts);
